...
|       | 表锁      | 锁定整个表             |
|       | 页锁      | 锁定数据页（介于行锁和表锁之间）  |
| 按公平性  | [[公平锁与非公平锁]] | 公平锁按 FIFO 排队，非公平锁允许插队     |
...
| [[MySQL SELECT FOR UPDATE 锁粒度分析]] | FOR UPDATE 的行锁、间隙锁、意向锁范围分析 |
| [[乐观锁]] | 版本号/CAS 乐观并发控制 |
| [[Java读写锁-ReadWriteLock]] | JVM 级别 ReadWriteLock，读写分离 |
| [[公平锁与非公平锁]] | 公平锁/非公平锁原理、AQS 实现、性能对比和选型 |
...
| 公平锁/非公平锁 | AQS（AbstractQueuedSynchronizer） | 非公平锁高 | ReentrantLock 公平性策略选择 |
